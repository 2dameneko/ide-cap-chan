...
def parse_arguments():
    ...
    parser.add_argument('--model_type', type=str, default="exllama2",
                        help='Model type (supported architectures: idefics3, llava, joy-caption, molmo, qwen2vl, molmo72b, pixtral, exllama2)')
    ...
    parser.add_argument('--caption_format', type=str, choices=['json', 'markdown', 'short', 'long', 'bbox'], default='long',
                        help='Format of the generated captions (supported formats: json, markdown, short, long, bbox)')
